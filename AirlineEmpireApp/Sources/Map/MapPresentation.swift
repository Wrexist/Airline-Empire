...
enum MapLabelLayout {
    ...
    /// already says.
    ///
    /// Not raised to 12: label boxes are tap targets, and at a framed home
    /// airport the full name's wider box is what a tap near the marker
    /// lands on. At 12, a tap beside Arlanda selected a neighbour instead
    /// (ShellAndMapUITests, CI run 36155847547).
