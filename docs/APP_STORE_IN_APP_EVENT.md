# In-App Event — Game Center Arrives (1.2)
...
The 1.2 update is different: Game Center is genuinely new, and **Major
...
attached to the 1.2 featuring nomination.

## Fields

| Field | Value | Limit |
|---|---|---|
| Reference name | 1.2 Game Center arrives | 64 |
| Badge | Major Update | — |
...
- **Event start:** the day 1.2 is live. The event must describe what is in
...
- **Submit** the event for review with, or after, the 1.2 version.

## Before submitting

1. 1.2 approved (or submitted alongside) with Game Center configured
   ([`GAME_CENTER.md`](GAME_CENTER.md) §3).
2. Open both images at full size once more; confirm nothing important is
   near the edges.
3. Attach the event to the 1.2 nomination.
